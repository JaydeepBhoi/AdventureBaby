...
public class StoneEnemy : MonoBehaviour
{
    ...
    public static StoneEnemy insance;
    ...
    public bool stoneStop;
    void Start()
    {

        Physics2D.IgnoreLayerCollision(11, 24);
        Physics2D.IgnoreLayerCollision(11, 25);
        Physics2D.IgnoreLayerCollision(11, 26);
        Physics2D.IgnoreLayerCollision(11, 28);


        stonePosition = gameObject.transform.position;
    ...
    void Update()
    {
        ...
        if (stoneStop == false)
        {
            transform.Rotate(Vector3.forward, speedStone * Time.deltaTime);
            transform.GetComponent<Rigidbody2D>().velocity = new Vector2(-5f, 0);
        }
    ...
    void PlantCall()
    {
        ...
        //    Player.instance.isJumping = false;
          ...
          //  Player.instance.moveVal = false;
            gameObject.transform.position = stonePosition;
